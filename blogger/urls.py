...
url(r'^category/(?P<title>[^\.]+).html', 'blogger.blog.views.category_post', name='view_category_post'),   
url(r'^new_category.html', 'blogger.blog.views.new_category', name='view_new_category'),  
